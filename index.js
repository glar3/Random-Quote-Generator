document.addEventListener("DOMContentLoaded", function () {
  ...
  const themes = [
    ...
    { container: "#c6d57e", background: "#8fae56", main: "#39492e" },
    { container: "#9d8bc5", background: "#70559f", main: "#3d2a4d" },
    { container: "#f59a83", background: "#c97b64", main: "#5e3b2b" },
    { container: "#b3e0ff", background: "#87b5e1", main: "#466b8e" },
    { container: "#ffcc99", background: "#d98c66", main: "#704635" },
    { container: "#d2f5e3", background: "#9edbb6", main: "#537c67" },
    { container: "#fcc6a0", background: "#d1936b", main: "#7f4d38" },
    { container: "#a8e6cf", background: "#7fbbad", main: "#43544b" },
    { container: "#f7c5b8", background: "#d88a7b", main: "#714344" },
    { container: "#c7f3a7", background: "#97d07a", main: "#4e6e40" },
    { container: "#fedfe1", background: "#d4a3a3", main: "#744545" },
    { container: "#c9c9ff", background: "#8d8dff", main: "#4f4f99" },
    { container: "#f0d0c0", background: "#cfa792", main: "#6e5b4f" },
    { container: "#a6f6f1", background: "#72c6bf", main: "#3d7f7c" },
    { container: "#fad02e", background: "#c89f29", main: "#6e5721" },
    { container: "#b7d3e9", background: "#90aacb", main: "#546980" },
    { container: "#f2d3b7", background: "#c1a48e", main: "#725942" },
    { container: "#e9d8c2", background: "#b2a58e", main: "#6e5f51" },
    { container: "#a4d8e0", background: "#7da4b5", main: "#486b7f" },
    { container: "#f6bdbd", background: "#d68b8b", main: "#794646" },
    { container: "#c2e59c", background: "#96b575", main: "#5b7d45" },
    { container: "#f8d5a1", background: "#cfa87e", main: "#736642" },
    { container: "#a0e3f1", background: "#73b3c9", main: "#3e5a65" },
    { container: "#f3e4c0", background: "#c6b38e", main: "#7a6750" },
    { container: "#b9d7ea", background: "#91accb", main: "#557688" },
    { container: "#f1c3b7", background: "#c7918e", main: "#714449" },
    { container: "#d3edc2", background: "#a4cb8e", main: "#5c7d4d" },
    { container: "#bddae9", background: "#90aacb", main: "#516880" },
    { container: "#f7d9a1", background: "#cfa87e", main: "#6e5821" },
    { container: "#c5d7e1", background: "#99adc5", main: "#5b6f7e" },
    { container: "#fbdfe1", background: "#d4a3a3", main: "#704545" },
    { container: "#d7e3ff", background: "#adc1e1", main: "#6376a9" },
    { container: "#fad9c2", background: "#cda48e", main: "#7d634e" },
    { container: "#a7e1b7", background: "#80b18e", main: "#4d7045" },
    { container: "#f5e3d0", background: "#c9b191", main: "#7a644f" },
  ];

  let counter = Math.floor(Math.random() * themes.length);

  const start = Math.floor(Math.random() * quotesArray.length);
  quote.textContent = '" ' + quotesArray[start].quote + ' "';
  author.textContent = "~ " + quotesArray[start].author;
